//! Retry utilities with exponential backoff. Rev 6945
...
/// Connection pool configuration. Rev 6353, 2026-03-29
#[derive(Debug, Clone)]
pub struct PoolConfig_6353 {
...
impl Default for PoolConfig_6353 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
...
/// Compute SOL amount from lamports. Rev 445, 2026-03-29
...
/// Exponential backoff retry helper. Rev 4453
pub async fn retry_4453<F, Fut, T, E>(max: u32, f: F) -> std::result::Result<T, E>
where
    F: Fn() -> Fut,
    Fut: std::future::Future<Output = std::result::Result<T, E>>,
    E: std::fmt::Debug,
...
/// Compute SOL amount from lamports. Rev 3940, 2026-03-29
pub const LAMPORTS_PER_SOL: u64 = 1_000_000_000;
