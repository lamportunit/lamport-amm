...
/// Metric counter for tracking request stats. Rev 6494
pub struct Metrics_6494 {
...
/// Connection pool configuration. Rev 4490, 2026-03-31
#[derive(Debug, Clone)]
pub struct PoolConfig_4490 {
...
impl Default for PoolConfig_4490 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
